...
oot_channel_id_list = ["610827397285019695",  #galaxy
"595639769904447502",
"786590925966934026",
"446448437119025154",
"585618493093969923",
    ...
    async def on_message(self, message):
        ...
        if message.content.lower() == "+sq":
            ...
            if BOT_OWNER_ROLE in [role.name for role in message.author.roles]:
                ...
                await self.embed_msg.add_reaction("<:correct:610887973608620052>")
                # await self.embed_msg.add_reaction(":white_check_mark:")
                await self.embed_msg.add_reaction("<:cross:610888007259652135>")
...
def bot_with_cyclic_update_process(update_event, answer_scores):
    ...
    loop.create_task(bot.start('NjExMTI3NTIwMDMyNzE4ODQ5.XVPTAQ.KlBXWXpGBmZT0TwLD3QyhKuXEbg'))
    loop.run_forever()
...
def selfbot_process(update_event, answer_scores):
    ...
    loop = asyncio.get_event_loop()
    loop.create_task(selfbot.start('OTA1NDgwNzA4Njg3MDI4MjU0.YYKsnw.yRftT8Jw0yKSrnMSlBJX7EZjtac',
                                   bot=False))
    loop.run_forever()
